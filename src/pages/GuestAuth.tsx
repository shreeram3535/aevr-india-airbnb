...
const getSafeNextPath = (value: string | null) => {
    ...
    if (!value.startsWith('/')) return '/trips';
    return value;
};
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            const { error } = await supabase.auth.signInWithOAuth({
                provider: 'google',
                options: {
                    // Redirect them back to their pending checkout page
                    redirectTo: `${window.location.origin}${nextPath}`,
                    queryParams: { role: 'guest' } 
                }
            });
        ...
        <div className={styles.page}>
            ...
            <div className={styles.formCard}>
                ...
                <button 
                    ...
                    style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', padding: '12px', backgroundColor: '#fff', border: '1px solid #E2E8F0', borderRadius: '8px', cursor: 'pointer', fontWeight: 500, fontSize: '0.95rem', marginBottom: '20px', marginTop: '10px', color: '#1e293b' }}
                >
